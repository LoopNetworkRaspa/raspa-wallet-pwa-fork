                            ...
                            <div class="info-ux">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>${KLS(inUseUTXOs.satoshis || 0)} RAS</td>
                                    </tr>
                                </table>
                                <flow-btn class="center-btn primary v-margin secondary default-button"
                ...
                ${this.isLoading ? html`
                    ...
                    <div class="balance pending">
                        <span class="label-pending">${T('PLEASE WAIT')} <span
                                class="dots">${this.dots}</span> ${total ? this.formatKLS(total) + ' RAS' : ''}</span>
                    </div>
                ` : html`
                    <div class="balance">
                        <span class="value">${this.formatKLS(available)} RAS</span>
                    </div>
                    <div class="balance pending">
                        <span class="label-pending" is="i18n-span">Pending:</span>
                        <span class="value-pending">${this.formatKLS(pending)} RAS</span>
                    </div>
                `}
            </div>
